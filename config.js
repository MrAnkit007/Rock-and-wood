...
module.exports = {
  ...
  head: {
    ...
    noscript: [
      {
        innerHTML: `We're sorry but Our Webapp doesn't work properly without JavaScript enabled. Please enable it to continue.`
      }
    ],
    htmlAttrs: { lang: 'en' },
